...
uv pip install --index-strategy unsafe-best-match -r src/requirements.txt  # unsafe-best-match mirrors pip and resolves pypi.org deps
...
uv pip uninstall cupy-cuda12x || true
