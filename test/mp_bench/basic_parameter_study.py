...
class BasicParameterStudy:
    ...
    def __setup(self):
        ...
        parser.add_argument("--response_size", type=int, default=4, help="size of the message to pass back")
        parser.add_argument("--work_items", type=int, default=8, help="number of work items in the parameter study")
