...
def add_default_args(desc):
    ...
    parser.add_argument("--num_iterations", type=int, default=4, help="number of iterations to do")
    parser.add_argument("--burn_iterations", type=int, default=1, help="number of iterations to burn first time")
    parser.add_argument("--json", action="store_true", help="output json")
    return parser


def add_connections_args(parser):
    parser.add_argument("--message_size", type=int, default=4, help="size of message to pass in")
    return parser


def add_token_args(parser):
    parser = add_connections_args(parser)
    parser.add_argument("--spins", type=int, default=100, help="number of times to send the token around a chain")
    parser.add_argument("--num_tokens", type=int, default=1, help="number of tokens to pass around the ring")
    return parser
