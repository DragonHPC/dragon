...
class AsCompletedTests:
    ...
    def test_no_timeout(self):
        ...
        completed = set(
            futures.as_completed([CANCELLED_AND_NOTIFIED_FUTURE, EXCEPTION_FUTURE, SUCCESSFUL_FUTURE, future1, future2])
        )
        self.assertEqual(
            set([CANCELLED_AND_NOTIFIED_FUTURE, EXCEPTION_FUTURE, SUCCESSFUL_FUTURE, future1, future2]),
            completed,
        )
    ...
    def test_future_times_out(self):
        ...
        already_completed = {CANCELLED_AND_NOTIFIED_FUTURE, EXCEPTION_FUTURE, SUCCESSFUL_FUTURE}
        ...
        for timeout in (0, short_timeout):
            with self.subTest(timeout):
                ...
                try:
                    for f in futures.as_completed(already_completed | {future}, timeout):
