...
class ItemInterpreterDestroyed(ChannelError, _crossinterp.ItemInterpreterDestroyed):
...
def list_all():
    ...
    return [(RecvChannel(cid), SendChannel(cid, _unbound=unbound)) for cid, unbound in _channels.list_all()]
    ...
    def send_buffer(
        ...
        *,
        ...
        if unbound is None:
            ...
            (unboundop,) = _serialize_unbound(unbound)
        _channels.send_buffer(self._id, obj, unboundop, timeout=timeout, blocking=True)
