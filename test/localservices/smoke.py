...
dying = dmsg.SHProcessCreate(
    tag=0, p_uid=dfacts.GS_PUID, r_c_uid=dfacts.GS_INPUT_CUID, t_p_uid=99, exe="/bin/sleep", args=["2"]
)
...
chatty = dmsg.SHProcessCreate(
    tag=1, p_uid=dfacts.GS_PUID, r_c_uid=dfacts.GS_INPUT_CUID, t_p_uid=100, exe="/bin/echo", args=["hyenas"]
)
