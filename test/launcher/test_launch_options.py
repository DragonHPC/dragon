...
class LaunchSelectionTest(unittest.TestCase):
    ...
    @unittest.skip("Skipped, need to reinvestigate")
...
class LaunchOptionsTest(unittest.TestCase):
    ...
    def test_too_many_nodes_requested(self, exceptions_caught_in_threads, mock_overlay, mock_launch):
        ...
        args_map = get_args_map(self.network_config, arg1=["--nodes", "10010"])
    ...
    def test_resilient_launch_no_nodes_requested(self, exceptions_caught_in_threads, mock_overlay, mock_launch):
        ...
        args_map = get_args_map(self.network_config, arg1=["--resilient"])
    ...
    def test_resilient_launch_bad_nidle_requested(self, exceptions_caught_in_threads, mock_overlay, mock_launch):
        ...
        args_map = get_args_map(self.network_config, arg1=["--resilient"], arg2=["--idle", "1000000"])
    ...
    def test_resilient_launch_bad_nidle_nnodes_requested(self, exceptions_caught_in_threads, mock_overlay, mock_launch):
        ...
        args_map = get_args_map(self.network_config, arg1=["--resilient"], arg2=["--idle", "13"], arg3=["--nodes", "4"])
    ...
    def test_nonint_nodes_requested(self, mock_stderr):
        ...
        with self.assertRaises(SystemExit):
            get_args_map(self.network_config, arg1=["--nodes", "abcdef"])
    ...
    def test_bad_port_requested(self, mock_stderr):
        ...
        with self.assertRaises(SystemExit):
            get_args_map(self.network_config, arg1=["--port", "23"])
        self.assertTrue("must be in port range 1024-65535" in mock_stderr.getvalue())

        with self.assertRaises(SystemExit):
            get_args_map(self.network_config, arg1=["--port", "799999"])
        self.assertTrue("must be in port range 1024-65535" in mock_stderr.getvalue())
    ...
    def test_bad_network_prefix(self, mock_stderr, mock_overlay, mock_launch):
        ...
        args_map = get_args_map(self.network_config, network_prefix="garbage-prefix", args1=["-l", "dragon_file=DEBUG"])
