...
if __name__ == '__main__':
    ...
    fe_mpool = MemoryPool(int(dfacts.DEFAULT_SINGLE_DEF_SEG_SZ),
    ...
    tree_proc = start_channel_tree(None, str(B64(local_ch.serialize())),
                                   encoded_ser_gw_str, host_ids, ip_addrs)
    ...
    backend_args = backend_args + ip_addrs + ['--host-ids'] + host_ids + ['--frontend-sdesc', encoded_inbound_str, '--node-index', '0']
