...
of how to do that using a `Queue` object and the python logging module.
...
them into a Queue object and sends them to a central process that is consuming the
