...
multiprocessing that is provided by the Dragon run-time services.
...
directory and execute the *start_jupyter.py* program as indicated here.

.. code-block:: text
    :linenos:

    root ➜ /workspaces/hpc-pe-dragon-dragon $ cd examples/jupyter/
    root ➜ /workspaces/hpc-pe-dragon-dragon/examples/jupyter $ dragon start_jupyter.py
