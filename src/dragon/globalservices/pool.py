...
def create(size, user_name='', options=None, soft=False):
    ...
    req_msg = dmsg.GSPoolCreate(tag=das.next_tag(), p_uid=this_process.my_puid,
                                r_c_uid=das.get_gs_ret_cuid(), size=size,
...
def get_list():
    """Asks Global Services for a list of the m_uids of all memory pools.
        ...
        """
    req_msg = dmsg.GSPoolList(tag=das.next_tag(), p_uid=this_process.my_puid,
...
def query(identifier):
    ...
    if isinstance(identifier, str):
        req_msg = dmsg.GSPoolQuery(tag=das.next_tag(), p_uid=this_process.my_puid,
                                   r_c_uid=das.get_gs_ret_cuid(),
                                   user_name=identifier)
    else:
        req_msg = dmsg.GSPoolQuery(tag=das.next_tag(), p_uid=this_process.my_puid,
                                   r_c_uid=das.get_gs_ret_cuid(),
                                   m_uid=int(identifier))
...
def destroy(identifier):
    ...
    """
    if isinstance(identifier, str):
        req_msg = dmsg.GSPoolDestroy(tag=das.next_tag(), p_uid=this_process.my_puid,
                                     r_c_uid=das.get_gs_ret_cuid(),
                                     user_name=identifier)
    else:
        req_msg = dmsg.GSPoolDestroy(tag=das.next_tag(), p_uid=this_process.my_puid,
