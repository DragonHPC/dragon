...
class sockaddr_in(ctypes.Structure):
    _fields_ = [
        *[
            ("sin_family", ctypes.c_ushort) if sys.platform == "linux" # Always AF_INET
...
class sockaddr_in6(ctypes.Structure):
    _fields_ = [
        *[
            ("sin6_family", ctypes.c_ushort) if sys.platform == "linux" # Always AF_INET6
...
class sockaddr(ctypes.Structure):
    _fields_ = [
        *[
            ("sa_family", ctypes.c_ushort) if sys.platform == "linux"
