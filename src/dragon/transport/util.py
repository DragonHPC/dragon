    ...
    if first_time_using_hsta_for_config:
        if use_hsta and 'DRAGON_BASE_DIR' in os.environ:
            ...
            try:
                ...
                log.debug(f'HSTA failed to run in dump-network-config mode, setting fabric_ep_addrs_available to false')
                return False, None, None
