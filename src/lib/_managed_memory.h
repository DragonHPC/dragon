...
#define DRAGON_MEMORY_DEFAULT_FILE_PREFIX "D"
#define DRAGON_MEMORY_DEFAULT_MANIFEST_SUFFIX "M"
#define DRAGON_MEMORY_DEFAULT_DATA_SUFFIX "D"
#define DRAGON_MEMORY_MAX_FILE_NAME_LENGTH 32
#define DRAGON_MEMORY_MAX_POOL_NAME_ENTRY_LENGTH 256
...
#define DRAGON_MEMORY_POOL_MAX_SERIALIZED_LEN (DRAGON_MEMORY_MAX_POOL_NAME_ENTRY_LENGTH + (sizeof(dragonULInt) * DRAGON_MEMORY_POOLSER_NULINTS))
