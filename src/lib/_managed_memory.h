...
#define DRAGON_MEMORY_DEFAULT_MIN_BLK_SIZE 4096
...
typedef struct dragonMemoryPoolHeap_st {
    ...
    dragonHashtable_t mfstmgr; // Manifest hashtable manager handle
...
typedef struct dragonMemoryManifestRec_st {
    dragonULInt alloc_type; // How it was allocated
    dragonULInt alloc_type_id; // Arbitrary ID from the user to make it unique
